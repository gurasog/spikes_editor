...
spikes_data_path='Rat_spikes_28_dataset.json'
data_path='Rat_spikes_28.mat'
...
if __name__ == '__main__':
    app.run_server(host='0.0.0.0', port=8105, debug=True, use_reloader=False, dev_tools_hot_reload=False)
