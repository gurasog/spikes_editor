...
spikes_data_path='Rat_classical_dataset.json'
data_path='Rat_classical_dataset.mat'
...
data=data_mat_file
times=np.linspace(0,1/250*data.shape[1],data.shape[1])
...
if __name__ == '__main__':
    app.run_server(host='0.0.0.0', port=10125, debug=True,use_reloader=False, dev_tools_hot_reload=False)
